    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(ALLOWED_PATHS)
                        ...
                        .requestMatchers("/api/v1/olymp/**").hasAnyAuthority(Role.ROLE_STUDENT.name(), Role.ROLE_OLYMPIAD_ADMIN.name(), Role.ROLE_ADMIN.name())
                        .requestMatchers("/api/v1/olympadmin/**").hasAnyAuthority(Role.ROLE_OLYMPIAD_ADMIN.name(), Role.ROLE_ADMIN.name())
                        .requestMatchers("/api/v1/estimate/**").hasAnyAuthority(Role.ROLE_INSPECTOR.name(), Role.ROLE_ADMIN.name())
