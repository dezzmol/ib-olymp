...
public enum ErrorCode {
    ...
    STUDENT_CANT_KICK_HIMSELF("Student can't kick himself", HttpStatusCode.valueOf(400)),
    ...
    RESULT_IS_ALREADY_SUMMARIZE("Result is already summarize", HttpStatusCode.valueOf(400)),
    RESULT_DOES_NOT_SUMMARIZE("Result doesn't summarize", HttpStatusCode.valueOf(400)),
